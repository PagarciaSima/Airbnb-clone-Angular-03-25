...
import { PicturesStepComponent } from './step/pictures-step/pictures-step.component';

@Component({
  selector: 'app-properties-create',
  standalone: true,
  imports: [CategoryStepComponent, FooterStepComponent, LocationStepComponent, InfoStepComponent, PicturesStepComponent],
